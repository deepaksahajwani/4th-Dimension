...
class VendorType(str, Enum):
    AUTOMATION_HOME_THEATRE = "Automation and Home Theatres"
    BUILDING_CHEMICALS = "Building Chemicals, Adhesives, Waterproofing"
    BUILDING_MATERIALS = "Building Materials (Cement, Sand, Aggregate, Steel)"
    CARPETS = "Carpets"
    CLEANING_SERVICES = "Cleaning Services"
    DECORATIVES = "Decoratives and Accessories, Paintings"
    ELECTRICAL = "Electrical (Wires, Switches, Lights, Fans)"
    ELECTRONIC_APPLIANCES = "Electronic and Electric Appliances"
    FALSE_CEILING = "False Ceiling (Grid, Metal, Soffit)"
    GARDENING = "Gardening Equipment, Nursery, Pots"
    GLASS_ALUMINUM = "Glass Work, Aluminum Interior Profile"
    GYPSUM_POP = "Gypsum and POP"
    HVAC = "HVAC"
    ISP = "Internet Service Provider"
    JHULA_SWING = "Jhula and Swing"
    KITCHEN_MODULAR = "Kitchen and Modular"
    MANDIR_DECORATIVE = "Mandir, Decorative Stones"
    MARBLE_GRANITE = "Marble and Granite"
    NETWORKING = "Networking Solutions"
    OFFICE_FURNITURE = "Office Furniture and Chairs"
    OUTDOOR_FURNITURE = "Outdoor Furniture"
    PAINT_FINISHES = "Paint, Wood and Surface Finishes"
    PLUMBING_FIXTURES = "Plumbing Material, Faucets, Bathroom Fixtures"
    PLYWOOD_HARDWARE = "Plywood, Hardware, Finish Material"
    READYMADE_FURNITURE = "Readymade Furniture (Sofa, Dining)"
    SECURITY_EQUIPMENT = "Security Equipment (Digital Locks, CCTV, EPABX, Fire Alarm)"
    SOLAR = "Solar"
    SOLID_SURFACE = "Solid Surface, Corian"
    TILES = "Tiles"
    UPHOLSTERY = "Upholstery and Soft Furnishings (Curtains, Blinds, Mattress)"
    WATER_SYSTEMS = "Water Purifiers, Geysers, Softeners, Water Harvesting"
    WINDOW_SYSTEMS = "Window Systems (UPVC, Aluminum)"
