...
async def notify_drawing_uploaded(project_id: str, drawing_name: str, uploaded_by_id: str):
    ...
    try:
        ...
        app_url = os.environ.get('FRONTEND_URL', 'https://review-page.preview.emergentagent.com')
...
async def notify_drawing_issued(
    ...
    try:
        ...
        # Create project link
        frontend_url = os.getenv('REACT_APP_BACKEND_URL', 'https://review-page.preview.emergentagent.com')
