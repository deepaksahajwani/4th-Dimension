...
async def get_email_preview(user_id: str = Query(None), role: str = Query(...), lang: str = Query('en')):
    ...
    try:
        ...
        login_url = os.getenv('REACT_APP_BACKEND_URL', 'https://architect-notify.preview.emergentagent.com')
...
@api_router.post("/webhooks/whatsapp/incoming")
...
@api_router.get("/webhooks/whatsapp/incoming")
