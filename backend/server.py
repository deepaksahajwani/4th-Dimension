...
async def get_email_preview(user_id: str = Query(None), role: str = Query(...), lang: str = Query('en')):
    ...
    try:
        ...
        login_url = os.getenv('REACT_APP_BACKEND_URL', 'https://pm-system.preview.emergentagent.com')
...
@api_router.post("/drawings/{drawing_id}/send-whatsapp")
...
@api_router.post("/drawings/{drawing_id}/request-approval")
